				...
				<tbody>
					...
					@foreach ($categories as $category)
						...
						<tr>
							...
							<td style='width:150px;'><div style='float:left; margin-right:5px;'><a href="{{ route('categories.show', $category->id) }}" class="btn btn-danger  btn-sm">Delete</a></div><div style='float:left;'></div>
							</td>
